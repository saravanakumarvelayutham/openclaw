...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.searxng.apiKey":
    "SearxNG API key (optional; fallback: SEARXNG_API_KEY env var).",
  "tools.web.search.searxng.baseUrl": "SearxNG base URL (fallback: SEARXNG_BASE_URL env var).",
  ...
  "agents.defaults.executorModel":
    "Optional executor model for tool-execution loops; run starts on the selected model and switches on first tool call.",
